...
var message = process.env.MESSAGE || 'Hello world, from IaC AKS Framework !';
...
var containerImage = process.env.CONTAINER_IMAGE || 'rhadi2005/hello-kubernetes:' + applicationVersion
